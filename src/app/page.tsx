            ...
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              >
                ...
                >
                  ...
                  <Typography>
                    Pigment CSS will look through Material UI components used in
                    the project and extract the styles into plain CSS.
                  </Typography>
                </li>
                <li
                  sx={{
                ...
                >
                  ...
                  <Typography>
                    Material UI provides a separate set of layout components
                    that integrate with Pigment CSS to support React Server
                    Components.
                  </Typography>
                </li>
                <li
